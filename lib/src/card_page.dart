...
child: Column(
  children: <Widget>[
    FadeInImage(placeholder: AssetImage("assets/Loading_2.gif") , 
    image: NetworkImage("https://www.fundacion-affinity.org/sites/default/files/el-gato-necesita-tener-acceso-al-exterior.jpg"),
